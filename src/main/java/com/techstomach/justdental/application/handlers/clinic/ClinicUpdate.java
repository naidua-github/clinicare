...
public class ClinicUpdate implements Handler<RoutingContext> {

    private Vertx vertx;
    private ConfigHandle configHandle;
    private static Logger log = LoggerFactory.getLogger(ClinicUpdate.class);

    public ClinicUpdate(Vertx vertx) {
        this.vertx = vertx;
    ...
    public void handle(RoutingContext routingContext) {
        ...
        String result = DbHandle.getInstance().updateClinic(dbRequest, "");
        if(result == null)
        {
        ...
        else
        {
            ...
            dbResponse.setBody(new Body()
                    ...
                    .setError(new Error("CLINIC UPDATE FAILED", result)));
