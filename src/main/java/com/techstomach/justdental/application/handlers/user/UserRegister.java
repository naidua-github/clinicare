...
public class UserRegister implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext routingContext) {
        ...
        String result = DbHandle.getInstance().insertUser(dbRequest, "");
        if(result == null)
        {
        ...
        else
        {
            ...
            dbResponse.setBody(new Body()
                    ...
                    .setError(new Error("USER REGISTRATION FAILED", result)));
